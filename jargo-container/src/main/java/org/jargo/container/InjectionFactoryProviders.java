 ...
 */
final class InjectionFactoryProviders extends 
        AbstractProviders<InjectionFactoryProvider> implements
    ...
    public <T> List<InjectionFactory<T>> getInjectionFactories(
        ...
        List<InjectionFactory<T>> injectors = new ArrayList<InjectionFactory<T>>();
        for (InjectionFactoryProvider provider : getProviders()) {
            injectors.addAll(provider.getInjectionFactories(configuration));
        }
