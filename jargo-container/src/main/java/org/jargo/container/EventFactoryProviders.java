 ...
 */
final class EventFactoryProviders extends 
        AbstractProviders<EventFactoryProvider> implements 
    ...
    public List<EventFactory> getEventFactories(
        ...
        for (EventFactoryProvider provider : getProviders()) {
            factories.addAll(provider.getEventFactories(configuration));
        }
