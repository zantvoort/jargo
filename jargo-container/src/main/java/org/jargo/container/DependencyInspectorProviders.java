 ...
 */
final class DependencyInspectorProviders extends 
        AbstractProviders<DependencyInspectorProvider> implements 
        DependencyInspectorProvider {
    
    public List<DependencyInspector> getDependencyInspectors(
            ComponentConfiguration configuration) {
        // No need to cache result.
        List<DependencyInspector> inspectors = 
                new ArrayList<DependencyInspector>();
        for (DependencyInspectorProvider provider : getProviders()) {
            inspectors.addAll(provider.getDependencyInspectors(configuration));
        }
